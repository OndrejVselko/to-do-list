    ...
    switch (previous = character3, character3 = next()) {
      ...
      case 0:
        switch (character3) {
          ...
          // ;
          case 59 + offset:
            if (ampersand == -1) characters3 = replace(characters3, /\f/g, "");
...
var getFunctionNameFromStackTraceLine = function getFunctionNameFromStackTraceLine2(line3) {
  var match3 = /^\s+at\s+([A-Za-z0-9$.]+)\s/.exec(line3);
  if (match3) return getLastPart(match3[1]);
  match3 = /^([A-Za-z0-9$.]+)@/.exec(line3);
  if (match3) return getLastPart(match3[1]);
  return void 0;
};
    ...
    switch (previous = character3, character3 = next2()) {
      ...
      case 0:
        switch (character3) {
          ...
          // ;
          case 59 + offset:
            if (ampersand == -1) characters3 = replace2(characters3, /\f/g, "");
...
function prefix4(value, length3) {
  switch (hash2(value, length3)) {
    ...
    case 5021:
    case 4765:
      if (strlen2(value) - 1 - length3 > 6) switch (charat2(value, length3 + 1)) {
        // (m)ax-content, (m)in-content
        case 109:
          if (charat2(value, length3 + 4) !== 45) break;
        // (f)ill-available, (f)it-content
        case 102:
    ...
    // position: sticky
    case 4949:
      if (charat2(value, length3 + 1) !== 115) break;
    // display: (flex|inline-flex)
    case 6444:
  ...
  return function() {
    ...
    Object.defineProperty(Styled, "toString", {
      value: function value() {
        if (targetClassName === void 0 && isDevelopment5) {
...
var processStyleName2 = memoize2(function(styleName) {
  ...
  if (Array.isArray(obj)) {
    ...
    for (var key in obj) {
      ...
      if (typeof value !== "object") {
        ...
        if (key === "NO_COMPONENT_SELECTOR" && isDevelopment6) {
          throw new Error(noComponentSelectorMessage2);
        }
        if (Array.isArray(value) && typeof value[0] === "string" && (registered == null || registered[value[0]] === void 0)) {
          for (var _i = 0; _i < value.length; _i++) {
...
function internal_serializeStyles(styles) {
  wrapper[0] = styles;
  return serializeStyles2(wrapper);
}
...
function cssContainerQueries(themeInput) {
  ...
  function attachCq(node4, name) {
    node4.up = (...args) => toContainerQuery(themeInput.breakpoints.up(...args), name);
    node4.down = (...args) => toContainerQuery(themeInput.breakpoints.down(...args), name);
    node4.between = (...args) => toContainerQuery(themeInput.breakpoints.between(...args), name);
    node4.only = (...args) => toContainerQuery(themeInput.breakpoints.only(...args), name);
    node4.not = (...args) => {
...
function useMediaQueryOld(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const [match3, setMatch] = React24.useState(() => {
    if (noSsr && matchMedia) {
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-2UFJU6JX.js.map
