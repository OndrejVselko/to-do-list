...
export default function TasksGrid({ data }) {
    ...
    const columns = [
        { field: 'type', headerName: 'Typ', flex: 1, minWidth: 100 },
        { field: 'name', headerName: 'Název', flex: 2, minWidth: 150 },
        {
            ...
            cellClassName: (params) => {
                const { rawDate, state } = params.row;
                const dateObj = new Date(rawDate);
                const isOverdue = state === 0 && dateObj < now;
                if (state === 1) return 'state-1-cell';
    ...
    return (
        <Box
            sx={{
                ...
                // Scrollbar pro všechny descendants (Chrome, Edge, Safari)
                '& *::-webkit-scrollbar': {
                    width: '8px',
                    height: '8px',
                },
            ...
            <DataGrid
                ...
                sx={{
                    ...
                    '& .MuiDataGrid-columnHeader': {
                        backgroundColor: 'var(--background_primary) !important',
                    },
